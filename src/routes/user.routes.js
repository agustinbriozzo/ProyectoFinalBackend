...
router.post('/:uid/upload-avatar/', passportCall("jwt"),uploadProfileImage.single('profiles'), uploadProfileUser);
router.post("/:uid/upload-documents/",passportCall("jwt"), uploadDocument.single('documents'), uploadDocumentUser);
